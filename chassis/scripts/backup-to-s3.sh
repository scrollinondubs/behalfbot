...
#   - $CHASSIS_HOME/scheduled-tasks/{heartbeat-state,heartbeat-suppressions,conservation-mode,halt,triaged-issues}.json
#                                         -> scheduled-tasks/
...
for f in heartbeat-state.json heartbeat-suppressions.json conservation-mode.json halt.json triaged-issues.json; do
