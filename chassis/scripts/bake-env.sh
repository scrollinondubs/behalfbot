...
echo ""
echo "Next:"
echo "  cd $CHASSIS_HOME"
echo "  docker compose --env-file=.env.baked \\"
echo "    -f chassis/docker-compose.yml \\"
echo "    -f chassis-compose.override.yml \\"
echo "    up -d --force-recreate chassis"
